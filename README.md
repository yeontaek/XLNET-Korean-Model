...
## SentencePiece tokenizer 학습
 1억 8천만 문장(위키피디아, 뉴스 데이터)을 활용하여 32,000개의 vocabulary (subwords)를 학습하였습니다. XLNET github에서는 model type을 unigram을 사용하였으나 해당 github에 문의 결과 다른 모델 타입도 문제가 없을 것이라고 하여 본 모델에서는 bpe type을 사용하여 구축하였습니다.(https://github.com/zihangdai/xlnet/issues/22)
